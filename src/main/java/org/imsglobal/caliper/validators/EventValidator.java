...
public interface EventValidator {
    ...
    public enum Conformance {
        ...
        DURATION_ERROR("calculating duration requires start and end time values"),
        DURATION_MISCALCULATED("duration miscalculated"),
        ...
        GENERATED_NOT_RESULT("generated object must be of type Result"),
        GENERATED_NOT_SESSION("generated object must be of type Session"),
        OBJECT_NOT_ANNOTATION("object must be of type Annotation"),
        OBJECT_NOT_ASSESSMENT("object must be of type Assessment"),
        OBJECT_NOT_ASSESSMENTITEM("object must be of type AssessmentItem"),
        OBJECT_NOT_ASSIGNABLE("object must be of type AssessmentDigitalResource"),
        OBJECT_NOT_ATTEMPT("object must be of type Attempt"),
        OBJECT_NOT_DIGITALRESOURCE("object must be of type DigitalResource"),
        OBJECT_NOT_MEDIA("object must be of type MediaObject"),
