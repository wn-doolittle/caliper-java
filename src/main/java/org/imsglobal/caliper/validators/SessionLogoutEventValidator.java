...
public class SessionLogoutEventValidator implements EventValidator {

    /**
     * Constructor
     */
    public SessionLogoutEventValidator() {
     ...
     *
     * /**
     * Validate SessionEvent.  An IllegalStateException will be thrown as a defensive measure if programing
