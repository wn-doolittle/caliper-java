...
public abstract class BaseEventWithContext implements Event, EventContext {
    ...
    @JsonIgnore
    private static final Logger log = LoggerFactory.getLogger(BaseEventWithContext.class);
     ...
     * @param builder
     */
    protected BaseEventWithContext(Builder<?> builder) {
