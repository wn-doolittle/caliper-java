...
public class MediaEvent implements Event {
    ...
    /**
     * Utilize builder to construct MediaEvent.  Validate MediaObject copy rather than the
     * MediaObject builder.  This approach protects the class against parameter changes from another
    ...
    /**
     * Required.  Override with a covariant return type (MediaObject).
     * @return the object
     */
    @Override
    ...
    public static class Builder {
        private final String event = "MediaEvent ";
        ...
        public Builder action(String actionKey) {
            if (MediaProfile.Actions.hasKey(actionKey)) {
         ...
         * @return builder.
         */
        public Builder object(MediaObject object) {
            this.object = object;
            return this;
        }
