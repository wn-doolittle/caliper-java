...
@JsonPropertyOrder({
    ...
    "edApp",
    "group" })
public class AssessmentItemEvent implements Event {
    ...
    /**
     * Required.  Override with a covariant return type (AssessmentItem).
     * @return the object
     */
    @Override
    ...
    public static class Builder  {
        private final String event = "AssessmentItemEvent ";
        ...
        public Builder action(String actionKey) {
            if (AssessmentItemProfile.Actions.hasKey(actionKey)) {
         ...
         * @return builder.
         */
        public Builder object(AssessmentItem object) {
            this.object = object;
            return this;
        }
         ...
         * @return a new instance of AssessmentItemEvent.
         */
